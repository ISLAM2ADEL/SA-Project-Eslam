...
<body>
  ...
  <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/02.jpg');">
      ...
      <?php for ($i = 0; $i < $number; $i++) {
        echo '<div class="col-xl-4 col-md-6"><div class="post-item position-relative h-100">';
              ...
              echo'<div class="post-content d-flex flex-column"><h3 class="post-title">'.$results[$i]['name'].'</h3>';
                ...
                echo'<div class="meta d-flex align-items-center"><div class="d-flex align-items-center"><span class="ps-2">'.$results[$i]['description'].'</span></div></div>';
